      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            <h2 className="text-amber-500 font-medium tracking-[0.2em] uppercase mb-4">About Mark</h2>
            <h3 className="text-3xl md:text-5xl font-serif text-white font-bold mb-8 leading-tight">
              Capturing God's Creation & Life's Precious Moments
            </h3>
            
            <div className="space-y-6 text-stone-300 leading-relaxed">
              <p>
                My journey from amateur to professional photographer has been guided by a simple belief: 
                <span className="text-amber-500"> life flows like a stream, but some moments deserve to be stopped and cherished forever.</span>
              </p>
              <p>
            ...
            <div className="mt-10 grid grid-cols-3 gap-6">
                {[
                    ...
                    <div key={idx} className="border-l border-amber-600 pl-4">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative">
                <div className="absolute -inset-4 border-2 border-amber-600/30 transform translate-x-4 translate-y-4"></div>
                <img 
