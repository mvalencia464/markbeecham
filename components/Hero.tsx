  ...
  return (
    <div id="home" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-amber-500 font-medium tracking-[0.2em] uppercase mb-4 animate-fade-in-up">
          Tennessee • Wildlife • Sports
        </h2>
        <h1 className="text-5xl md:text-7xl font-serif text-white font-bold mb-6 leading-tight tracking-tight shadow-sm">
          Capturing Awe-Inspiring<br />Moments
        </h1>
        <p className="text-xl md:text-2xl text-stone-300 mb-10 max-w-2xl mx-auto font-light">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#contact"
            className="group bg-amber-600 hover:bg-amber-500 text-white px-8 py-4 text-sm tracking-widest uppercase font-bold transition-all duration-300 flex items-center gap-2"
          >
            Capture Your Memory
