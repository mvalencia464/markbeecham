    ...
    <section id="services" className="py-24 bg-stone-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-amber-500 font-medium tracking-[0.2em] uppercase mb-4">Investment</h2>
          ...
          {PACKAGES.map((pkg, index) => (
            <div 
              ...
              className={`relative flex flex-col p-8 ${
                pkg.highlight 
                  ? 'bg-stone-900 ring-2 ring-amber-500 transform lg:-translate-y-4 shadow-2xl shadow-amber-900/20' 
                  : 'bg-stone-900 border border-stone-800 hover:border-stone-700'
              } transition-all duration-300`}
            >
              {pkg.highlight && (
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-amber-600 text-white text-xs font-bold uppercase tracking-widest px-4 py-1">
                  Most Popular
                </div>
              )}
